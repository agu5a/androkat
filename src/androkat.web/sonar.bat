...
dotnet sonarscanner begin /k:"androkat.web" /d:sonar.login="admin" /d:sonar.password="2VFws3fkGQQu7Qn" /d:sonar.host.url="http://localhost:9000" /d:sonar.coverage.exclusions="**/Program.cs, **/*.cshtml, **/*.js" /d:sonar.cs.opencover.reportsPaths="**/TestResults/**/coverage.opencover.xml" -d:sonar.cs.vstest.reportsPaths="**/TestResults/*.trx"
...
dotnet sonarscanner end /d:sonar.login="admin" /d:sonar.password="2VFws3fkGQQu7Qn"