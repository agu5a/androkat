...
public class IndexTests : BaseTest
{
	...
	public void OnGet_With_Data_Test()
	{
		...
		var video = fixture.Create<VideoContent>();
		...
		var ima = fixture.Create<ImaContent>();
		...
		var systeminfo = fixture.Create<SystemInfo>();
		systeminfo.Key = "radio";
		systeminfo.Value = "{ \"szentistvan\": \"url\"}";
		systeminfo.Id = 1;

		var radioMusor = fixture.Create<RadioMusor>();
		...
		var model = new IndexModel(logger.Object, repo, authService.Object, cronService.Object, generalConfig)
		{
		...
		const string expected = "<strong>Ma hiányzó anyagok</strong>" +
								"<br> 1 - <a href='https://androkat.hu' target='_blank'>Anthony de Mello</a>" +
								"<br> 2 - <a href='https://szentgellertkiado.hu' target='_blank'>Pio atya breviáriuma</a>" +
								"<br> 3 - <a href='https://szentgellertkiado.hu' target='_blank'>II. János Pál pápa breviáriuma</a>" +
								"<br> 4 - <a href='https://www.karmelitarend.hu' target='_blank'>Keresztes Szent János aranymondásai</a>" +
								"<br> 5 - <a href='https://www.karmelita.hu' target='_blank'>Kis Szent Teréz breviáriuma</a>" +
								"<br> 6 - <a href='https://evangelium365.hu' target='_blank'>Horváth István Sándor (evangélium365.hu)</a>" +
								"<br> 8 - <a href='https://szentgellertkiado.hu' target='_blank'>Teréz Anya breviáriuma</a>" +
								...
								"<br> 12 - <a href='https://szikrak.jezsuita.hu' target='_blank'>Loyolai Szent Ignác gondolatai</a>" +
								"<br> 13 - <a href='https://barsitelekmm.blogspot.hu' target='_blank'>Barsi és Telek - Magasság és mélység</a>" +
								"<br> 14 - <a href='https://evangelium365.hu' target='_blank'>Horváth István Sándor (evangélium365.hu)</a>" +
								"<br> 15 - <a href='https://open.spotify.com/show/4f2oWtBVw0jnTmeDrHh7ey' target='_blank'>Jezsuita napi-útra-való</a>" +
								"<br> 17 - <a href='https://szentgellertkiado.hu' target='_blank'>Böjte Csaba testvér gondolatai</a>" +
								"<br> 19 - <a href='https://szentgellertkiado.hu' target='_blank'>Kempis Tamás: Krisztus követése (válogatás)</a>" +
								"<br> 24 - <a href='https://szentgellertkiado.hu' target='_blank'>Szeretet-újság</a>" +
								"<br> 25 - <a href='https://szentgellertkiado.hu' target='_blank'>Nevessünk!</a>" +
								...
								"<br> 42 - <a href='https://szentgellertkiado.hu' target='_blank'>Vianney Szent János breviáriuma</a>" +
								...
								"<br> 48 - <a href='https://www.szfvar.katolikus.hu/proima/prohaszka_breviarium' target='_blank'>Prohászka Ottokár breviáriuma</a>" +
								"<br> 50 - <a href='https://ciszterna.ocist.hu' target='_blank'>Szent Bernát idézetek minden napra</a>" +
								"<br> 52 - <a href='https://www.kairosz.hu/' target='_blank'>Szalézi Szent Ferenc: Gondolatok minden napra</a>" +
								"<br> 57 - <a href='https://www.facebook.com/profile.php?id=100050238980182' target='_blank'>Varga László megyéspüspök gondolatai</a>" +
								"<br> 58 - <a href='https://szentgellertkiado.hu' target='_blank'>AJÁNDéKOZZ KÖNYVET</a>" +
								"<br> 60 - <a href='https://www.taize.fr' target='_blank'>Taizé napi imák</a>" +
								"<br> 61 - <a href='https://szentgellertkiado.hu' target='_blank'>Sienai Szent Katalin breviáriuma</a>" +
								...
								"<br><strong>Mai anyagok</strong><br> 7 - <a href='https://www.fokolare.hu' target='_blank'>Fokoláre: életige</a>" +
	...
	public void OnGet_Failed_Auth_Test()
	{
		...
		var cronService = new Mock<ICronService>();
		var generalConfig = Options.Create(new GeneralConfiguration());
		var model = new IndexModel(logger.Object, adminRepository.Object, authService.Object, cronService.Object, generalConfig)
		{
			PageContext = pageContext,
			TempData = tempData,
			Url = new UrlHelper(actionContext)
