...
{
    public const string p11 = "Áldoztam-e halálos bűn állapotában?";
    public const string p12 = "Elmulasztottam-e imádkozni mindennap?";
    public const string p13 = "Hazudtam gyónásban, elhallgattam súlyos bűnt?";
    public const string p14 = "Hittem babonában, horoszkópban és egyéb divatos dolgokban?";
    public const string p15 = "Nem igyekszem szeretni Istent teljes szívemből?";
    ...
    public const string p24 = "Zúgolódtam-e Isten ellen? Voltam-e kishitű vagy vakmerő?";
    public const string p25 = "Viccelődtem szent dolgokról? Nem bánom, ha másoktól hallom?";

    public const string p31 = "Vasárnap, ünnepnap mulasztottam-e szentmisét? (Hanyagságból? Hányszor?)";
    public const string p32 = "Szentmisén Isten és az ott levők iránt nem szeretettel és figyelemmel vettem részt?";
    ...
    public const string p35 = "Nem tartom a kötelező és más böjtöket? Nem törekszem azt lelkivé tenni, vagy csak muszájból végzem?";

    public const string p41 = "Nem tisztelem szüleimet? Nem vagyok engedelmes? Nem próbálok örömet szerezni nekik?";
    public const string p42 = "Nem tisztelem az idősebbeket, vezetőimet, tanáraimat stb.?";
    ...
    public const string p53 = "Csábítottam, bátorítottam-e mást bűnre?";
    public const string p54 = "Közlekedésben nem felelősen veszek részt?";

    public const string p61 = "Ruházkodásomban nem vagyok körültekintő másokra és az alkalomra?";
    public const string p62 = "Nem tisztelek másokat, testüket? Önző vágyaim céljára használom őket?";
    public const string p63 = "Nem kerülöm az alkalmakat és gondolatokat, ami bűnbeesésre buzdít másokkal és magammal szemben?";
    ...
    public const string p74 = "Nem becsülettel használom időmet tanulásban, munkában?";
    ...
    public const string p91 = "Nem imádkozom, hogy le tudjam győzni a kísértéseket, bűnös gondolatokat?";
    public const string p92 = "Hagyom a fantáziálásom, gondolataim eluralkodjanak rajtam?";
    public const string p93 = "Nem tisztelem házastársamat, nem tudom őt elfogadni minden testi-lelki tulajdonságát? Összehasonlítgattom őt másokkal?";

    public const string p101 = "Önző vagyok? Irigykedtem-e (más értékeire, tehetségére stb.)?";
    public const string p102 = "Hálátlan vagyok Istennel szemben? Elégedetlen azzal szemben, amit kaptam tőle?";
    public const string p103 = "Nem bízok Isten gondviselésében? Aggódom testi-lelki szükségleteimért?";
    public const string p104 = "Isten helyett a világ dolgai, az anyagi javak életem fő céljai?";
}
