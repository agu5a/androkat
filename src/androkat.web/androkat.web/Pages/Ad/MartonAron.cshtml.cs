...
[Authorize]
[BindProperties]
public class MartonAronModel : PageModel
{
    private readonly IAdminRepository _adminRepository;

    public MartonAronModel(IAdminRepository adminRepository)
    {
    ...
    public void OnPost()
    {
        ...
        var (isSuccess, message) = _adminRepository.InsertFixContent(Cim, Idezet, (int)Forras.martonaron, Datum);
