...
<body>{htmlContent}</body>
    ...
    public static string InjectFontSizeIntoHtml(string htmlContent, double fontSize)
    {
        ...
        {
            // Add font-size to existing body style (for formatted string)
            return htmlContent.Replace("body {{", $"body {{\n            font-size: {fontSize}px;");
        }
        else if (htmlContent.Contains("body style='"))
        {
            // Add font-size to existing body style attribute
